...
function loadCharacters() {
    ...
    // Clear the current character grid and reset page number when a new search or sort is triggered
    const characterGrid = document.getElementById('character-grid');
    characterGrid.innerHTML = ''; // Clear grid before adding new characters
