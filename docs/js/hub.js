...
function displayCharacters(characters) {
    ...
    // Function to load and display a single character
    ...
    // Start by loading characters one by one as they come in
    characters.forEach(character => loadCharacter(character));
}
